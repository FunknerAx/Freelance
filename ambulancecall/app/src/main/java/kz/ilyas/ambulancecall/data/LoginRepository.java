...
public class LoginRepository {
    ...
    public void login(LoginViewModel loginViewModel, LoginActivity loginActivity, String username, String password) {
        // handle login
        Result<LoggedInUser> result = null;
        dataSource.login(this,loginViewModel,loginActivity, username, password);
